...
def run_NSW_Q_learning(episodes, alpha, epsilon, gamma, nsw_lambda, init_val, dim_factor, tolerance, file_name, mode, non_stationary, run):
    Q = np.zeros([fair_env.observation_space.n, fair_env.action_space.n, 3], dtype=float)
...
if __name__ == '__main__':
    ...
    for i in range(1,11):   # Do 50 runs, and then take the average
