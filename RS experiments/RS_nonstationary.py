...
def run_NSW_Q_learning(episodes, alpha, epsilon, gamma, nsw_lambda, init_val, dim_factor, non_stationary, run):
    ...
    if non_stationary == False:
        # np.save(file='/Users/oliviafan/Desktop/RG_data3/NSW_Penalty_V2_run{}_no_gamma'.format(run),
        #         arr=Q)
        np.save(file='/Users/oliviafan/Desktop/RG_histdata/NSW_Penalty_V2_run{}_no_gamma_nsw'.format(run),
                arr=nsw_data)
        np.save(file='/Users/oliviafan/Desktop/RG_histdata/NSW_Penalty_V2_run{}_no_gamma_total'.format(run),
                arr=total_data)
        np.save(file='/Users/oliviafan/Desktop/RG_histdata/NSW_Penalty_V2_run{}_no_gamma_hist'.format(run),
                arr=hist_data)
    else:
        # np.save(file='/Users/oliviafan/Desktop/RG_data3/NSW_Penalty_V2_run{}_stat_gamma'.format(run),
        #         arr=Q)
        np.save(file='/Users/oliviafan/Desktop/RG_histdata/NSW_Penalty_V2_run{}_scaled_fair_nsw'.format(run),
                arr=nsw_data)
        np.save(file='/Users/oliviafan/Desktop/RG_histdata/NSW_Penalty_V2_run{}_scaled_fair_total'.format(run),
                arr=total_data)
        np.save(file='/Users/oliviafan/Desktop/RG_histdata/NSW_Penalty_V2_run{}_scaled_fair_hist'.format(run),
                arr=hist_data)
...
if __name__ == '__main__':
    ...
    for i in range(1,8):   # Do 50 runs, and then take the average
